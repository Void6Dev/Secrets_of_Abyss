...
namespace SoA.Common.Graphics
{
    ...
    public class CameraFocusFx : ModSystem
    {
        ...
        public static void Focus(Vector2 worldTarget, int durationTicks = 120, int easeTicks = 40)
        {
            if (Main.dedServ)
                return;
            _target = worldTarget;
        ...
        public static void Focus(NPC npc, int durationTicks = 120, int easeTicks = 40)
        {
            if (Main.dedServ)
                return;
