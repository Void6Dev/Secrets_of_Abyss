...
namespace SoA.Content.NPCs.Bosses.KingCrab
{
    ...
    public partial class King_crab
    {
        ...
        // Экранных фильтров (Filters.Scene) у босса НЕТ намеренно. Полноэкранные эффекты —
        // искажение, тинт, виньетка, десатурация — неизбежно меняют яркость всего кадра, а бой
        // должен идти на неизменно светлом экране. Весь VFX короля сущностный: кольца, вспышки,
        // пыль и свечения вокруг самой туши.
