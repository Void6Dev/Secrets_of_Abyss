...
namespace SoA.Content.Projectiles
{
    ...
    {
        public override string Texture => "SoA/Content/Projectiles/ShardedSpearBeamMid";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D quadTex = ModContent.Request<Texture2D>("SoA/Content/Projectiles/ShardedSpearBeamMid").Value;
